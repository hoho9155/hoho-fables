...
public enum TargetPlateHPDisplay : byte
{
    None = 0,
    HPRemaining = 1,
    HPRemainingAndMaxHP = 2,
    PercentageRemaining = 3,
    PercentageRemainingAndMaxPercentage = 4,
    HPRemainingAndPercentageRemaining = 5,
    HPRemainingAndMaxHPAndPercentageRemaining = 6,
    HPRemainingAndMaxHPAndPercentageRemainingAndMaxPercentage = 7
}
...
public enum Monster : ushort
{
    ...
    Metamorph = 876,
    WoomyonFighter = 877,
    WoomyonGuardian = 878, // Needs Frames
    WoomyonKing = 879, // Needs Frames
    WoomyonSoldier = 880,
    WoomyonTrooper = 881, // Needs Frames
    WoomyonWarrior = 882,
    RedCaveSnake = 883,
    GreenCaveSnake = 884,
    TigerCaveSnake = 885,
...
public static class Globals
{
    ...
    public const uint SearchDelay = 500,
                      ConsignmentLength = 365,
                      ConsignmentCost = 2000,
                      MinConsignment = 5000,
