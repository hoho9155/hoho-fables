...
namespace ServerPackets
{
    ...
    public sealed class ObjectPlayer : Packet
    {
        ...
        public byte Hair;
        public byte Light;
		public short Weapon, WeaponEffect, Armour, Shield, EquipShieldEffect;
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            EquipShieldEffect = reader.ReadInt16();
        ...
        protected override void WritePacket(BinaryWriter writer)
        {
            ...
            writer.Write(Shield);
            writer.Write(EquipShieldEffect);
            writer.Write(Armour);
    ...
    public sealed class ObjectMonster : Packet
    {
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            MaximumHP = reader.ReadUInt16();
            PercentageHeath = reader.ReadByte();
            MonsterGrade = reader.ReadByte();
            MobLevel = reader.ReadByte();
        }
        ...
        protected override void WritePacket(BinaryWriter writer)
        {
            ...
            writer.Write((UInt16)Level);
            writer.Write((UInt16)CurrentHP);
            writer.Write((UInt16)MaximumHP);
            writer.Write((byte)PercentageHeath);
            writer.Write((byte)MonsterGrade);
            writer.Write((byte)MobLevel);
        }
    ...
    public sealed class ObjectHealth : Packet
    {
        ...
        public uint CurrentHP, MaximumHP;
