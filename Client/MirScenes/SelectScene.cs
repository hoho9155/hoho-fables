...
namespace Client.MirScenes
{
    public class SelectScene : MirScene
    {
        ...
        public SelectScene(List<SelectInfo> characters)
        {
            ...
            CharacterButtons = new CharacterButton[7];
            ...
            CharacterButtons[6] = new CharacterButton
            {
                Location = new Point(447, 434),
                Parent = Background,
                Sound = SoundList.ButtonA,
            };
            CharacterButtons[6].Click += (o, e) =>
            {
                if (characters.Count <=6) return;
        ...
        public void StartGame(S.StartGame p)
        {
            ...
            {
                CMain.ActiveForm.FormBorderStyle = FormBorderStyle.None;
                CMain.ActiveForm.Location = new Point(0, 0);
            }
            ...
            //else if (p.Resolution >= 1366 && Settings.Resolution >= 1366) Settings.Resolution = 1920;
            ...
            switch (p.Result)
            {
                ...
                case 4:
                    ...
                    else if (Settings.Resolution == 1600)
                        CMain.SetResolution(1600, 900);
                    else if (Settings.Resolution == 1920)
                        CMain.SetResolution(1920, 1080);
                    else if (Settings.Resolution == 2560)
                        CMain.SetResolution(2560, 1440);
