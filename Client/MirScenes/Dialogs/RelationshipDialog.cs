    ...
    public sealed class RelationshipDialog : MirImageControl
    {
        ...
        public RelationshipDialog()
        {
            ...
            RequestButton.Click += (o, e) =>
            {
                if (LoverName != "")
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("You're already married.", ChatType.System);
                    return;
                }
            ...
            DivorceButton.Click += (o, e) =>
            {
                if (LoverName == "")
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("You're not married.", ChatType.System);
                    return;
                }
            ...
            WhisperButton.Click += (o, e) =>
            {
                ...
                if (MapName == "")
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("Lover is not online", ChatType.System);
                    return;
                }
                GameScene.Scene.ChatControl.chatDialog.ChatTextBox.SetFocus();
                GameScene.Scene.ChatControl.chatDialog.ChatTextBox.Text = ":)";
