    ...
    public sealed class TrustMerchantDialog : MirImageControl
    {
        ...
        public TrustMerchantDialog()
        {
            ...
            FindButton.Click += (o, e) =>
            {
                ...
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat(string.Format("You can search again after [{0}] seconds.", Math.Ceiling((SearchTime - CMain.Time) / 1000D)), ChatType.System);
                    return;
                }
        ...
        public sealed class AuctionRow : MirControl
        {
            ...
            protected override void OnMouseEnter()
            {
                ...
                base.OnMouseEnter();
                GameScene.Scene.CreateItemLabel(Listing.Item,false, (Control.ModifierKeys == Keys.Alt));
            }
