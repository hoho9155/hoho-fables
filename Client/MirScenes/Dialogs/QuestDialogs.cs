...
namespace Client.MirScenes.Dialogs
{
    ...
    public sealed class QuestDiaryDialog : MirImageControl
    {
        ...
        public void DisplayQuests()
        {
            ...
            _takenQuestsLabel.Text = string.Format("Quests: {0}/{1}", Quests.Count, Globals.MaxConcurrentQuests);
            ...
            foreach (var group in groupedQuests)
            {
                ...
                QuestGroupQuestItem groupQuest = new QuestGroupQuestItem(group.Key, singleGroup, false)
                {
                    Parent = this,
                    Visible = true,
                    Location = new Point(60, nextY),
                };
                //groupQuest._expandButton.Click += (o, e) =>
                //{
                //    foreach (QuestGroupQuestItem task in TaskGroups)
                //    {
                //        task.Expanded = (task == o as QuestGroupQuestItem) ? true : false;
                //        //  task.ChangeExpand();
                //    }
                ...
                groupQuest.ExpandedChanged += (o, e) =>
                {
                    ...
                    foreach (QuestGroupQuestItem task in TaskGroups)
                    {
                        ...
                        task.Location = new Point(60, nextY);
                        nextY += task.SizeY;
    ...
    public sealed class QuestTrackingDialog : MirImageControl
    {
        ...
        public List<MirImageControl> TaskBackgrounds = new List<MirImageControl>();
        ...
        {
            Index = 1;
            Library = Libraries.QuestTracker;
            Movable = true;
        ...
        public void DisplayQuests()
        {
            foreach (MirLabel label in TaskLines)
                label.Dispose();
            foreach (MirImageControl bgimg in TaskBackgrounds)
                bgimg.Dispose();
            ...
            {
                MirImageControl bg = new MirImageControl
                {
                    Index = 0,
                    Library = Libraries.QuestTracker,
                    Location = new Point(0, 20 + y),
                    Parent = this,
                    Visible = true,
                };
                TaskBackgrounds.Add(bg);
                ...
                foreach (string questToTrack in questsToTrack[i].TaskList)
                {
                    ...
                    _questTaskLabel = new MirLabel
                    {
                        ...
                        ForeColour = trackedQuest.Contains("(Completed)") ? Color.LimeGreen : Color.White,
        ...
        {
            if (TrackedQuestsIds.Any(d => d == quest.Id) || TrackedQuestsIds.Count >= 10) return;
        ...
        private void NewText(List<string> lines, bool resetIndex = true)
        {
            ...
            for (int i = TopLine; i < BottomLine; i++)
            {
                ...
                _textLabel[i - TopLine] = new MirLabel
                {
                    ...
                    Location = new Point(0, 0 + (i - TopLine) * 15 + adjust),
                    NotControl = true
                };
    ...
    public sealed class QuestCell : MirControl
    {
        ...
        protected override void OnMouseEnter()
        {
            ...
            if (ShowItem == null) ShowItem = new UserItem(Item) { MaxDura = Item.Durability, CurrentDura = Item.Durability };
                ...
                GameScene.Scene.CreateItemLabel(ShowItem,false, (Control.ModifierKeys == Keys.Alt));
        }
    ...
    public sealed class QuestGroupQuestItem : MirControl
    {
        ...
        public readonly MirButton _expandButton;
        ...
        public void ChangeExpand()
        {
            ...
            _expandButton.Index = Expanded ? 382 : 381;
    ...
    public sealed class QuestSingleQuestItem : MirControl
    {
        ...
        public QuestSingleQuestItem(ClientQuestProgress quest)
        {
            ...
            _questLabel = new MirLabel
            {
                ...
                AutoSize = true,
                Font = new Font(Settings.FontName, 8F),
                ForeColour = lowLevelQuest ? Color.LightGray : quest.New ? Color.Yellow : Color.White,
                Parent = this,
                Location = new Point(0, 0),
                Sound = SoundList.ButtonA
            };
                    ...
                    case MouseButtons.Right:
                        {
                            ...
                            {
                                if (GameScene.Scene.QuestTrackingDialog.TrackedQuestsIds.Count >= 10) return;
