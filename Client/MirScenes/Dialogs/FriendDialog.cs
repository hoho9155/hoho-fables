    ...
    public sealed class FriendDialog : MirImageControl
    {
        ...
        public FriendDialog()
        {
            ...
            WhisperButton.Click += (o, e) =>
            {
                ...
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("Player is not online", ChatType.System);
                    return;
                }

                GameScene.Scene.ChatControl.chatDialog.ChatTextBox.SetFocus();
                GameScene.Scene.ChatControl.chatDialog.ChatTextBox.Text = "/" + SelectedFriend.Name + " ";
