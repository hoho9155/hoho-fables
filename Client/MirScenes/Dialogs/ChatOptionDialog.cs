...
namespace Client.MirScenes.Dialogs
{
    public class ChatOptionDialog : MirImageControl
    {
        ...
        private void CheckAllFilters()
        {
            ...
            GameScene.Scene.ChatControl.chatDialog.Update();
        }
        ...
        private void UpdateTransparency()
        {
            ...
            {
                GameScene.Scene.ChatControl.chatDialog.ForeColour = Color.FromArgb(190, 15, 0, 0);
                GameScene.Scene.ChatControl.chatDialog.BackColour = Color.FromArgb(190, 15, 0, 0);
            ...
            {
                GameScene.Scene.ChatControl.chatDialog.ForeColour = Color.White;
                GameScene.Scene.ChatControl.chatDialog.BackColour = Color.White;
