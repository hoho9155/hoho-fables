    ...
    public sealed class MentorDialog : MirImageControl
    {
        ...
        public MentorDialog()
        {
            ...
            AddButton.Click += (o, e) =>
            {
                if (MentorLevel != 0)
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("You already have a Mentor.", ChatType.System);
                    return;
                }
            ...
            RemoveButton.Click += (o, e) =>
            {
                if (MentorName == "")
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("You don't currently have a Mentorship to cancel.", ChatType.System);
                    return;
                }
