...
namespace Client.MirGraphics
{
    public static class Libraries
    {
        ...
        public static readonly MLibrary
            ...
            UI = new MLibrary(Settings.DataPath + "UI-0"),
            MonIcon = new MLibrary(Settings.DataPath + "MonIcon"),
            ...
            MiniMapZoom2 = new MLibrary(Settings.DataPath + "MMapZ2"),
            ...
            QuestTracker = new MLibrary(Settings.DataPath + "QuestTracker"),
        ...
        public static readonly MLibrary[] CArmours = new MLibrary[200],
                                          CWeapons = new MLibrary[264],
										  CWeaponEffect = new MLibrary[70],
										  CHair = new MLibrary[9],
                                          CHumEffect = new MLibrary[150],
                                          CShields = new MLibrary[27],
                                          AArmours = new MLibrary[26],
                                          AWeaponsL = new MLibrary[34],
                                          AWeaponsR = new MLibrary[34],
                                          AHair = new MLibrary[9],
                                          AHumEffect = new MLibrary[9],
                                          ARArmours = new MLibrary[23],
                                          ARWeapons = new MLibrary[19],
                                          ARWeaponsS = new MLibrary[19],
                                          ARHair = new MLibrary[9],
                                          ARHumEffect = new MLibrary[7],
                                          Monsters = new MLibrary[1000],
                                          Gates = new MLibrary[2],
                                          Flags = new MLibrary[12],
                                          Mounts = new MLibrary[12],
                                          NPCs = new MLibrary[210],
        ...
        static Libraries()
        {
            ...
            for (int i = 0; i < CShields.Length; i++)
                CShields[i] = new MLibrary(Settings.CShieldsPath + i.ToString("00"));
        ...
        private static void LoadGameLibraries()
        {
            ...
            if (Client.Settings.InitializeLibraries)
            {
                MiniMap.Initialize();
                Progress++;
            }
            MiniMapZoom2.Initialize();
            Progress++;
            ...
            Loaded = true;
            Client.Settings.InitializeLibraries = true;
        }
    ...
    public sealed class MLibrary
    {
        ...
        public void Draw(int index, int x, int y)
        {
            ...
            DXManager.Sprite.Draw2D(mi.Image, Point.Empty, 0, new Point(x, y), Color.White);
        ...
        public void DrawZoom(int index, Rectangle section, Point point, Color colour, float opacity, byte Zoom)
        {
            if (!CheckImage(index))
                return;
