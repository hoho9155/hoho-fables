    ...
    public sealed class GameShopCell : MirImageControl
    {
        ...
        public void BuyProduct()
        {
            ...
            { //Needs to attempt to pay with gold and credits
                ...
                {
                    GameScene.Scene.ChatControl.chatDialog.ReceiveChat("You can't afford the selected item.", ChatType.System);
                    return;
                }
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (ShowItem == null && ItemDisplayArea != null && ItemDisplayArea.Contains(CMain.MPoint))
            {
                ...
                GameScene.Scene.CreateItemLabel(ShowItem,false, (Control.ModifierKeys == Keys.Alt), Item.Count);
            }
