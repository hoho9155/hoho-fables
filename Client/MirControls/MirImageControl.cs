        ...
        protected internal override void DrawControl()
        {
            ...
            if (DrawImage && Library != null)
            {
                ...
                if (GrayScale)
                {
                 ...
                 if (Blending) Library.DrawBlend(Index, DisplayLocation, ForeColour, false, BlendingRate);
                else
                if (!ViewRectangle.IsEmpty)
                    Library.Draw(Index, ViewRectangle, Fixed ? DisplayLocation : DisplayLocation.Add(ViewRectangle.Location), ForeColour, false);
