    ...
    public sealed class MirTextBox : MirControl
    {
        ...
        private void TextBox_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (TextBox.Visible && TextBox.CanFocus)
                if (CMain.ActiveForm.ActiveControl == null || CMain.ActiveForm.ActiveControl == CMain.ActiveForm)
                    CMain.ActiveForm.ActiveControl = TextBox;

            if (!TextBox.Visible)
                if (CMain.ActiveForm.ActiveControl == TextBox)
                    CMain.ActiveForm.Focus();
        }
        ...
        void TextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                CMain.ActiveForm.ActiveControl = null;
                e.Handled = true;
            }
        }
        ...
        {
            TextBox.Parent = CMain.ActiveForm;
            CMain.Ctrl = false;
            CMain.Shift = false;
            CMain.Alt = false;
            CMain.Tilde = false;
