...
namespace Client.MirObjects
{
    class MonsterObject : MapObject
    {
        ...
        public void Load(S.ObjectMonster info, bool update = false)
        {
            ...
            PercentHealth = info.PercentageHeath;
            MonsterGrade = info.MonsterGrade;
            MobLevel = info.MobLevel;
            ...
            switch (BaseImage)
            {
                ...
                // HighRes Mobs
                case Monster.RedHog:
                case Monster.BlackHog:
                case Monster.WhiteHog:
                case Monster.GreenHog:
                    Frames = FrameSet.Monsters[208];
                    break;

                // Mob Pack 2
                case Monster.StrawMan:
                case Monster.Mummy:
                case Monster.Metamorph:
                case Monster.WoomyonFighter:
                case Monster.WoomyonSoldier:
                case Monster.WoomyonWarrior:
                case Monster.RedCaveSnake:
                case Monster.GreenCaveSnake:
                case Monster.TigerCaveSnake:
                    Frames = FrameSet.Monsters[209];
                    break;
                case Monster.Xiuhcoatl:
                    Frames = FrameSet.Monsters[210];
                    break;
                case Monster.SkeletalDragon:
