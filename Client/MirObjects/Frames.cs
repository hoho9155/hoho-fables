...
namespace Client.MirObjects
{
    public class FrameSet
    {
        ...
        static FrameSet()
        {
            ...
            Players.Frames.Add(MirAction.Attack1, new Frame(136, 6, 0, 100, 168, 6, 0, 100)); // Original
            Players.Frames.Add(MirAction.Attack2, new Frame(184, 6, 0, 100, 216, 6, 0, 100)); // Original
            Players.Frames.Add(MirAction.Attack3, new Frame(136, 6, 0, 100, 168, 6, 0, 100)); // Same as attack 1
            //Players.Frames.Add(MirAction.Attack3, new Frame(232, 8, 0, 100, 264, 8, 0, 100)); // Origina;
            ...
            //21 1 Dir + animation(18 frames)
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 17, 0, 100));

            //22 1 Dir + animation(7 frames)
            NPCs.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 7, 0, 150) { Blend = true });
            #endregion
            ...
            //208 - HighRes - RedHog, BlackHog, WhiteHog
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 3, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(152, 10, 0, 100));
            frame.Frames.Add(MirAction.Dead, new Frame(161, 1, 9, 1000));

            //209 - Mob Pack 2 - Strawman, Mummy, Metamorph, cavesnakes
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            ...
            //210 - MRandom mobs FireSerpent
            Monsters.Add(frame = new FrameSet());
            frame.Frames.Add(MirAction.Standing, new Frame(0, 4, 0, 500));
            frame.Frames.Add(MirAction.Walking, new Frame(32, 6, 0, 100));
            frame.Frames.Add(MirAction.Attack1, new Frame(80, 6, 0, 100));
            frame.Frames.Add(MirAction.Struck, new Frame(128, 2, 0, 200));
            frame.Frames.Add(MirAction.Die, new Frame(144, 10, 0, 100) { Blend = true });
            frame.Frames.Add(MirAction.Dead, new Frame(153, 1, 9, 1000) { Blend = true });
