...
namespace Client
{
    public partial class CMain : Form
    {
        ...
        public CMain()
        {
            ...
            //SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.UserPaint | ControlStyles.Selectable, true); // paul
            SetStyle(ControlStyles.UserPaint | ControlStyles.UserPaint | ControlStyles.Selectable, true); // paul
        ...
        public void CreateScreenShot()
        {
            ...
            string text = string.Format("[{0} Server {1}] [{2}] {3:hh\\:mm\\:ss}", 
                Settings.P_ServerName.Length > 0 ? Settings.P_ServerName : "The Last Chapter", 
        ...
        private void CMain_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                GameScene.Scene.ChatControl.chatDialog.ReceiveChat("Cannot leave game for " + (GameScene.LogTime - CMain.Time) / 1000 + " seconds.", ChatType.System);
                e.Cancel = true;
            }
        }
    }
