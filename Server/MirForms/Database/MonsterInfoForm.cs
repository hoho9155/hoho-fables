...
namespace Server
{
    public partial class MonsterInfoForm : Form
    {
        ...
        private void UpdateInterface()
        {
            ...
            MobGrade.Text = info.MobGrade.ToString();
            ...
            for (int i = 1; i < _selectedMonsterInfos.Count; i++)
            {
                ...
                if (MobGrade.Text != info.MobGrade.ToString()) MobGrade.Text = string.Empty;
        ...
        private void MobGrade_TextChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < _selectedMonsterInfos.Count; i++)
                _selectedMonsterInfos[i].MobGrade = temp;
        }
    }
}