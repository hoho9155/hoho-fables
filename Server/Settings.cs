...
namespace Server
{
    ...
    {
        public static Point[] LocationOffsets = new Point[] { new Point(0, 0), new Point(1, 0), new Point(1, 1), new Point(0, 1), new Point(-1, 1), new Point(-1, 0), new Point(-1, -1), new Point(0, -1), new Point(1, -1), new Point(2, -1), new Point(2, 0), new Point(2, 1), new Point(2, 2), new Point(1, 2), new Point(0, 2), new Point(-1, 2), new Point(-2, 2), new Point(-2, 1), new Point(-2, 0), new Point(-2, -1), new Point(-2, -2), new Point(-1, -2), new Point(0, -2), new Point(1, -2), new Point(2, -2), new Point(3, -2), new Point(3, -1), new Point(3, 0), new Point(3, 1), new Point(3, 2), new Point(3, 3), new Point(2, 3), new Point(1, 3), new Point(0, 3), new Point(-1, 3), new Point(-2, 3), new Point(-3, 3), new Point(-3, 2), new Point(-3, 1), new Point(-3, 0), new Point(-3, -1), new Point(-3, -2), new Point(-3, -3), new Point(-2, -3), new Point(-1, -3), new Point(0, -3), new Point(1, -3), new Point(2, -3), new Point(3, -3), new Point(4, -3), new Point(4, -2), new Point(4, -1), new Point(4, 0), new Point(4, 1), new Point(4, 2), new Point(4, 3), new Point(4, 4), new Point(3, 4), new Point(2, 4), new Point(1, 4), new Point(0, 4), new Point(-1, 4), new Point(-2, 4), new Point(-3, 4), new Point(-4, 4), new Point(-4, 3), new Point(-4, 2), new Point(-4, 1), new Point(-4, 0), new Point(-4, -1), new Point(-4, -2), new Point(-4, -3), new Point(-4, -4), new Point(-3, -4), new Point(-2, -4), new Point(-1, -4), new Point(0, -4), new Point(1, -4), new Point(2, -4), new Point(3, -4), new Point(4, -4) };
        ...
        public static string GMPassword = "s937ufhsjk";
        ...
        //StarterGuild
        public static string StartersGuild = "StartersGuild";
        public static int StarterExp = 10;
        ...
        public static void Load()
        {
            ...
            if (!Directory.Exists(AchievementsStats))
                Directory.CreateDirectory(AchievementsStats);
