...
namespace Server.MirDatabase
{
    public class CharacterInfo
    {
        ...
        public UserItem[] Inventory = new UserItem[46], Equipment = new UserItem[15], Trade = new UserItem[10], QuestInventory = new UserItem[40], Refine = new UserItem[16];
    ...
    public class IntelligentCreatureInfo
    {
        ...
        static IntelligentCreatureInfo()
        {
            ...
            BabySkeleton = new IntelligentCreatureInfo
            {
                ...
                AutoPickupEnabled = true,
                AutoPickupRange = 6,
                MinimalFullness = 3800,
                CanProduceBlackStone = true,
                Info = "Can pickup items (6x6).",
                Info1 = "Can produce BlackStones."
            };
            ...
            Monkey = new IntelligentCreatureInfo {
                PetType = IntelligentCreatureType.BabyMonkey,
                Icon = 511,
                AutoPickupEnabled = true,
                AutoPickupRange = 5,
                MinimalFullness = 4000,
            ...
            AngryBird = new IntelligentCreatureInfo {
                PetType = IntelligentCreatureType.AngryBird,
                Icon = 512,
                AutoPickupEnabled = true,
                AutoPickupRange = 5,
                MinimalFullness = 35000,
                CanProduceBlackStone = true,
                Info = "Can pickup items (5x5).",
                Info1 = "Can produce BlackStones."
            };
    ...
    public class UserIntelligentCreature
    {
        ...
        public IntelligentCreaturePickupMode petMode = IntelligentCreaturePickupMode.Automatic;
