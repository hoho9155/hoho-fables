...
namespace Server.MirObjects
{
    public sealed class NPCObject : MapObject
    {
        ...
        public const string
            ...
            BuyUsedKey = "[@BUYUSED]",
            NPCSpeak = "[NPCSPEAK]"; //why theres no @ on it? like the others^
        ...
        {
            string path = Settings.GoodsPath + Info.Index.ToString() + ".msdn";
        ...
        public List<PlayerObject> FindNearby(int distance)
        {
